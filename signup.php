...
ini_set('sendmail_from', "somyasbharti@gmail.com");*/

//<!--Check user inputs-->
//    <!--Define error messages-->
global $errors;
$headers = 'From: somyasbharti@gmail.com' . "\r\n".
    'MIME-Version: 1.0'."\r\n".
...
$message .= "http://localhost/project/activate.php?email=" . urlencode($email) . "&key1=$activationKey";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'somyasbharti@gmail.com',$headers)){
