          ...
          <div class="container-fluid">
              ...
              <div class="navbar-collapse collapse" id="navbarCollapse">
                  <ul class="nav navbar-nav">
                    <li class="active"><a href="#" style="color:midnightblue ">Profile</a></li>
                    <li><a href="#" style="color:midnightblue ">Help</a></li>
                    <li><a href="#" style="color:midnightblue ">Contact us</a></li>
                      <li><a href="mainpage.php" style="color:midnightblue ">My Notes</a></li>
                  </ul>
                  <ul class="nav navbar-nav navbar-right">
                      <li><a href="#" style="color:midnightblue ">Logged in as <strong> <?php echo $username; ?></strong> </a></li>
                    <li><a href="index.php?ut=1" style="color:midnightblue ">Log out</a></li>
                  </ul>
