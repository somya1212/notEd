  ...
  <body>
      ...
      <div class="container-fluid">
          <div class="navbar-header">
              <strong>
              <a style="color:  midnightblue" class="navbar-brand">Online Notes</a>
          ...
          <strong>
          <div class="navbar-collapse collapse" id="navbarCollapse" class="color-me">
              
               <ul class="nav navbar-nav">
                    <li class="active" ><a style="color:midnightblue " href="#">Home</a></li>
                    <li><a style="color:  midnightblue" href="#">Help</a></li>
                    <li><a style="color:  midnightblue"  href="#">Contact us</a></li>
                  </ul>
                  <ul class="nav navbar-nav navbar-right">
                    <li><a style="color:  midnightblue" href="#loginModal" data-toggle="modal">Login</a></li>
                  </ul>
...
<div class="modal" id="signupModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="footer">
          <div class="container">
              <p><strong><!---Designed and Developed by Somya Bharti (17BCE2187).----></strong></p>
          </div>
      </div>
